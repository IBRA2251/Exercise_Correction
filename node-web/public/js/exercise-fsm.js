...
class ExerciseSession {
    ...
    evaluateRep() {
        ...
        const FEEDBACK = {
            ...
            pullup: {
                rom_very_shallow: "Barely moving — start from a full dead hang and pull to the bar",
                rom_shallow:      "Increase your range — dead hang at bottom, chin over bar at top",
                rom_moderate:     "Getting there — full extension at the bottom, pull higher",
                rom_good:         "Good range, just a bit more at the top for full reps",
                rom_excellent:    "Full range pull-up — excellent lat engagement!",
                speed_too_slow:   "Explode upward — don't grind through the sticking point",
                speed_slow:       "Drive with your elbows, pull with more power",
                speed_fast:       "Slow the descent — control the eccentric, don't drop",
                speed_too_fast:   "Way too fast — slow controlled pull-ups build more strength",
                speed_good:       "Excellent tempo — controlled pull and smooth descent",
                bottom_too_high:  "Start from a full dead hang — full arm extension at bottom",
                top_not_extended: "Pull until your chin clears the bar — go higher",
                alignment_issue:  "Keep your core tight and avoid swinging your legs",
                praise_full:      "Textbook pull-up — full range, strong pull, controlled descent!",
            },
            lunge: {
                rom_very_shallow: "Barely bending — lower your hips until both knees hit 90°",
                rom_shallow:      "Lunge deeper — front thigh should be parallel to floor",
                rom_moderate:     "Almost there — drive your back knee closer to the ground",
                rom_good:         "Good depth, squeeze the glute as you push back up",
                rom_excellent:    "Perfect lunge depth — full range, great balance!",
                speed_too_slow:   "Drive upward with more power through your front heel",
                speed_slow:       "Add some energy — push explosively back to starting position",
                speed_fast:       "Slow down — control the descent to protect your knees",
                speed_too_fast:   "Too fast! 2 seconds down, 1 second up for best results",
                speed_good:       "Great lunge tempo — controlled and balanced",
                bottom_too_high:  "Your bottom position is too high — drop your hips more",
                top_not_extended: "Fully straighten your leg at the top — lock your hip out",
                alignment_issue:  "Keep your torso upright and front knee tracking over your toes",
                praise_full:      "Perfect lunge — great depth, balance, and control!",
            },
        };
